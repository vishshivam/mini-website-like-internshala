...
$data=$internship->fetch_internship_data();
 ?><h1 class="display-4 p-5 text-center"><?php print_r($data->num_rows);?> Internships Available </h1>
<div class="container">
<!----show intenships---->
	<?php
			...
			<div class="col bg-light pt-3 mb-5">
				<div class="internship_section">
					...
					<div class="row mt-3 footer_part bg-primary text-light pt-1">
						...
						<div class="col-2">
							<a href="internship_Details_Page.php?internship_id=<?php echo $obj->INTERNSHIPS_ID;?>" class="text-light"><b>View Details</b></a>
						</div>
					</div>
				</div>
			</div>

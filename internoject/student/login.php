<?php
session_start();
	if (isset($_REQUEST['student_login_btn'])) {
   include_once 'Student.php';
  $student = new Student();
		extract($_REQUEST);
	    $login = $student->check_student_login($s_email, $password);
	    }
?>
<!doctype html>
<html lang="en">
      ...
      if (isset($_REQUEST['student_login_btn'])) {
        ...
        ?>
            ...
            <div class="form-group">
              ...
              <input type="email" name="s_email" class="form-control" placeholder="Enter email">
            </div>
        ...
        <input type="submit" name="student_login_btn" class="btn btn-primary btn-block" value="Login"/>
